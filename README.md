...
| M-02 | 文件夹管理 | P1 | 占位 |
| M-03 | AI 视觉识别 | P1 | 本地规则识别 + 专家调教规则应用已实现 |
| M-04 | 标注 | P1 | 产品价格库专家标签 + 价值判断 + 逻辑关系沉淀已实现 |
| M-05 | 专家审核 | P1 | 专家校正 + 调教规则沉淀已实现 |
| M-06 | 材质库 | P0 | 基础 CRUD 已实现 |
| M-07 | 词典 | P1 | 占位（工具A已有） |
| M-08 | 统计/RAG | P1 | 本地历史报价检索已实现 |
| M-09 | Prompt 管理 | P1 | 占位 |
| **M-10** | **报价引擎** | **P0** | **本地五维报价初版已实现** |
| **M-11** | **混元3D** | **P0** | **占位** |
| **M-12** | **Seedream 材质** | **P0** | **占位** |
| **M-13** | **Three.js 查看器** | **P0** | **占位** |
| M-14 | 报价单生成 | P1 | 三语 HTML + 外贸 PI XLSX + 中文内销 XLSX 已实现 |
| **M-15** | **客户档案** | **P0** | **基础 CRUD 已实现** |
| M-16 | 业务流程引擎 | P1 | 14步状态机初版已实现 |
| M-17 | 钉钉集成 | P1 | 占位 |
| M-18 | 客户门户 | P2 | 占位 |
| M-19 | 安全防泄露 | P1/P2 | 占位 |
