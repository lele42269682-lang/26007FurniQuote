...
```python
from modules.m07_dict.schema import DictInput, DictOutput
```
...
```bash
# 自动化测试
pytest tests/auto/test_m07_dict.py

# 模块自测（热拔插）
python -m modules.m07_dict.main
```
...
□ tests/auto/test_m07_dict.py 通过
□ utils/logger 已接入
