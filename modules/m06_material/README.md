...
```python
from modules.m06_material.schema import MaterialInput, MaterialOutput
```
...
```bash
# 自动化测试
pytest tests/auto/test_m06_material.py

# 模块自测（热拔插）
python -m modules.m06_material.main
```
...
□ tests/auto/test_m06_material.py 通过
□ utils/logger 已接入
